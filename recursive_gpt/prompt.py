...
def get_prompt():
    ...
    commands = [
        ...
        # ("Add Memory", "add_memory", {"text": "<text>"}),
    ...
    prompt_generator.add_resource("A task list to add simple and complex tasks to.")
    prompt_generator.add_resource("File system for storing and retrieving information.")
